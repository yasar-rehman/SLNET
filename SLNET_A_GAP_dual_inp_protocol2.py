...
def main(args):
    ...
    for i in range(len(training_data)):
        if training_label_r[i] == 0:
            ...
            live_samples_ub += 1
        elif (training_label_r[i] == 1) | (training_label_r[i] == 2) | (training_label_r[i] == 4):  # protocol_2
    ...
    while batch_num < args.max_epochs:
        ...
        model_final.save_weights(
            '/home/yaurehman2/Documents/stereo_face_liveness/stereo_ckpt/Conventional/' + 'dual_grayscale_input_revised_protocol_2_'+ str(args.max_epochs) + '.h5')
